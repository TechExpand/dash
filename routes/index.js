  ...
  router.post("/sendotp/:phone", async (req, res, next) => {
    ...
    Verify.create({
      ...
      .then(async (banks) => {
        ...
        const response = await axios.post(`https://account.kudisms.net/api/?username=anthony@martlines.ng&password=sirador@101&message=${code} is your Dash pin. Do not share this with anyone.&sender=Dash&mobiles=${req.params.phone}`);
